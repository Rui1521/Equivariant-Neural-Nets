...
class Conv2d(pl.LightningModule):
    def __init__(self, in_channels, out_channels, kernel_size, sout = 5):
        ...
        #self.batchnorm = nn.BatchNorm3d(sout)
...
#         for i in range(1,9):
#             self.model[i].layer1.weights.detach_()
#             self.model[i].layer2.weights.detach_()
#         self.model[0].weights.detach_()    
#         self.final_layer.weight.detach_()
#         self.final_layer.bias.detach_()
