...
class scale_conv2d(nn.Module):
    def __init__(self, out_channels, in_channels, kernel_size, l = 3, sout = 5, activation = True):
        ...
        weight_shape = (out_channels, l, in_channels, kernel_size, kernel_size)
...
class ResNet(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size):
        ...
        layers += [scale_conv2d(out_channels = out_channels, in_channels = 128, kernel_size = kernel_size, sout = 1, activation = False)]
