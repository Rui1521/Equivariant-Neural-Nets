...
class Resblock(torch.nn.Module):
    def __init__(self, input_channels, hidden_dim, kernel_size, N, res):
...
class ResNet(torch.nn.Module):
    def __init__(self, input_frames, kernel_size, N):
        ...
        self.feat_type_hid_out = nn.FieldType(r2_act, 32*[r2_act.regular_repr])
        self.feat_type_out = nn.FieldType(r2_act, [r2_act.irrep(1)])
...
class U_net(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        #concat1 = torch.cat((out_conv1.tensor, out_deconv1.tensor), 1)
